...
function ProductsPage() {
  ...
  return (
    <DashboardPage
      title="Products"
      description="Digital files, services, and free links. Articles live in their own list."
      action={
        <div className="flex flex-wrap gap-2">
          <Button asChild variant="secondary">
            <Link to="/dashboard/articles/new">Write article</Link>
          </Button>
          <Button asChild>
              ...
              >
                ...
                <div className="min-w-0 flex-1 py-0.5">
                  ...
                  <p className="mt-1 line-clamp-1 text-sm text-muted">
                    {htmlToPlain(product.description) || "No description"}
                  </p>
